...
+ (void)reqInternationalQRActivationWithAccount:(id _Nullable)account activation:(id _Nullable)activation viewController:(UIViewController * _Nonnull)viewController callback:(void (^ _Nonnull)(id _Nullable, NSError * _Nullable))callback;
